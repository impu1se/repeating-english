...
export const exercises: Exercise[] = [
  ...
  { id: 'va2-e10', conceptId: 'va2-daily', type: 'fill_gap', prompt: 'You need a valid ___ to cross the border.', points: 1, accepted: ['passport'] },
  ...
  { id: 'va2-e12', conceptId: 'va2-daily', type: 'multi_gap', prompt: 'After the long flight, she was so ___ that she left her ___ at the airport.', points: 1, gaps: [{ accepted: ['tired', 'exhausted'] }, { accepted: ['suitcase'] }] },
