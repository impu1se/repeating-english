...
export const exercises: Exercise[] = [
  ...
  // ============ b1-used-to ============
  // --- translate_ru_en ---
  { id: 'b1ut-e1', conceptId: 'b1-used-to', type: 'translate_ru_en', prompt: 'Раньше я играл в футбол каждые выходные.', points: 2, accepted: ['I used to play football every weekend', 'I used to play soccer every weekend', 'Every weekend I used to play football', 'I would play football every weekend', 'I would play soccer every weekend', 'Every weekend I would play football', "I'd play football every weekend", "I'd play soccer every weekend", "Every weekend I'd play football"] },
