...
export const exercises: Exercise[] = [
  ...
  // --- choose_word ---
  { id: 'b2sh-e11', conceptId: 'b2-should-have', type: 'choose_word', prompt: 'You ___ told me about the party earlier!', points: 1, options: ['should have', 'should', 'should had'], accepted: ['should have'] },
